...
public class TimerHookTests {
	...
	public void cleanUp() throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
		// Field objectStoragesField = coreService.getClass().getDeclaredField("objectStorages");
		// objectStoragesField.setAccessible(true);
		// Map<String, IObjectStorage> objectStorages = (Map<String, IObjectStorage>)
		// objectStoragesField.get(coreService);
		// System.out.println(objectStorages.size());
