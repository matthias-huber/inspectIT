...
// statementHook = new StatementHook(timer, platformManager, connectionMetaDataStorage,
// statementReflectionCache, parameter);
// statementHook2 = new StatementHook(timer, platformManager, connectionMetaDataStorage,
// statementReflectionCache, parameter);
//
...
//
// statementHook.firstAfterBody(methodId, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
// verify(timer, times(2)).getCurrentTime();
//
// statementHook.secondAfterBody(coreService, methodId, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
...
//
// verify(coreService).addMethodSensorData(eq(sensorTypeId), eq(methodId), (String)
// Matchers.anyObject(), (MethodSensorData) Matchers.anyObject());
// verify(coreService).getMethodSensorData(eq(sensorTypeId), eq(methodId), (String)
// Matchers.anyObject());
...
// verify(timer, times(2)).getCurrentTime();
// statementHook2.firstAfterBody(methodId, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
// verify(timer, times(3)).getCurrentTime();
// statementHook2.secondAfterBody(coreService, methodId, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
//
// statementHook.firstAfterBody(methodId, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
...
// bsqld.setSql((String) parameters[0]);
//
// verify(coreService, times(2)).addMethodSensorData(eq(sensorTypeId), eq(methodId), (String)
// Matchers.anyObject(), (MethodSensorData) Matchers.anyObject());
// verify(coreService, times(2)).getMethodSensorData(eq(sensorTypeId), eq(methodId), (String)
// Matchers.anyObject());
// verifyNoMoreInteractions(timer, platformManager, coreService, registeredSensorConfig);
// }
//
