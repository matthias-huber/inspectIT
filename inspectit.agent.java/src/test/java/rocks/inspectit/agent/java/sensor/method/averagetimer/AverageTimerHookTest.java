...
//
// averageTimerHook.firstAfterBody(methodId, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
// verify(timer, times(2)).getCurrentTime();
//
// averageTimerHook.secondAfterBody(coreService, methodId, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
...
// verify(coreService).addMethodSensorData(eq(sensorTypeId), eq(methodId), (String) eq(null),
// argThat(new TimerDataVerifier(timerData)));
//
...
// when(platformManager.getPlatformId()).thenReturn(platformId);
//
// averageTimerHook.beforeBody(methodIdOne, sensorTypeId, object, parameters,
// registeredSensorConfig);
// averageTimerHook.beforeBody(methodIdTwo, sensorTypeId, object, parameters,
// registeredSensorConfig);
//
// averageTimerHook.firstAfterBody(methodIdTwo, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
// averageTimerHook.secondAfterBody(coreService, methodIdTwo, sensorTypeId, object, parameters,
...
// verify(coreService).addMethodSensorData(eq(sensorTypeId), eq(methodIdTwo), (String) eq(null),
// argThat(new TimerDataVerifier(timerDataTwo)));
//
// averageTimerHook.firstAfterBody(methodIdOne, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
// averageTimerHook.secondAfterBody(coreService, methodIdOne, sensorTypeId, object, parameters,
// result, registeredSensorConfig);
...
// verify(coreService).addMethodSensorData(eq(sensorTypeId), eq(methodIdOne), (String) eq(null),
// argThat(new TimerDataVerifier(timerDataOne)));
// }
//
// @Test
...
// assertThat(timerData.getDuration(), is(equalTo(((fourthTimerValue - thirdTimerValue) +
// secondTimerValue) - firstTimerValue)));
...
// registeredSensorConfig);
//
// verify(coreService, never()).addMethodSensorData(anyLong(), anyLong(), anyString(),
// (MethodSensorData) isNull());
// }
//
// @Test
