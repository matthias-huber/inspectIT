...
// @BeforeMethod
// public void init() {
// invocationSequenceHook = new InvocationSequenceHook(timer, platformManager, propertyAccessor,
...
// invocationSequenceHook.secondAfterBody(coreService, methodId, sensorTypeId, object, parameters,
// result, rsc);
//
// verify(timer, times(2)).getCurrentTime();
// ArgumentCaptor<InvocationSequenceData> captor =
// ArgumentCaptor.forClass(InvocationSequenceData.class);
// verify(coreService, times(1)).addMethodSensorData(eq(sensorTypeId), eq(methodId),
// Matchers.<String> anyObject(), captor.capture());
//
...
// invocationSequenceHook.secondAfterBody(coreService, methodId2, sensorTypeId, object, parameters,
// result, rsc);
// invocationSequenceHook.firstAfterBody(methodId1, sensorTypeId, object, parameters, result, rsc);
// invocationSequenceHook.secondAfterBody(coreService, methodId1, sensorTypeId, object, parameters,
// result, rsc);
//
// verify(timer, times(4)).getCurrentTime();
// ArgumentCaptor<InvocationSequenceData> captor =
// ArgumentCaptor.forClass(InvocationSequenceData.class);
// verify(coreService, times(1)).addMethodSensorData(eq(sensorTypeId), eq(methodId1),
// Matchers.<String> anyObject(), captor.capture());
//
// InvocationSequenceData invocation = captor.getValue();
// assertThat(invocation.getPlatformIdent(), is(platformId));
...
// verify(timer, times(4)).getCurrentTime();
// verify(coreService, times(1)).addMethodSensorData(eq(sensorTypeId), eq(methodId),
// Matchers.<String> anyObject(), Matchers.<InvocationSequenceData> anyObject());
// }
//
// /**
...
// when(timer.getCurrentTime()).thenReturn(firstTimerValue, secondTimerValue, thirdTimerValue,
// fourthTimerValue, fifthTimerValue);
//
...
// invocationSequenceHook.secondAfterBody(coreService, methodId3, sensorTypeId, object, parameters,
// result, rsc);
// invocationSequenceHook.firstAfterBody(methodId2, sensorTypeId, object, parameters, result,
// removingRsc);
// invocationSequenceHook.secondAfterBody(coreService, methodId2, sensorTypeId, object, parameters,
// result, removingRsc);
// invocationSequenceHook.firstAfterBody(methodId1, sensorTypeId, object, parameters, result, rsc);
...
// */
// @Test(dataProvider = "skippingSensors")
// public void skipSensorWithEnchancedExceptionSensor(Class<? extends ISensor> sensorClass) throws
