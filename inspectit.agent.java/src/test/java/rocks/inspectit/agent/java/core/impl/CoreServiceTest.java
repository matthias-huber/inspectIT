...
// when(bufferStrategy.next()).thenReturn(dataList);
//
// coreService.addExceptionSensorData(sensorTypeId,
// exceptionSensorData.getThrowableIdentityHashCode(), exceptionSensorData);
// coreService.sendData();
//
// synchronized (this) {
// wait(3000);
...
// long sensorTypeId = 1;
// long methodId = 5;
// PlainTimerStorage timerStorage = new PlainTimerStorage(null, 0, sensorTypeId, methodId,
// Collections.<ParameterContentData> emptyList(), false);
// when(bufferStrategy.hasNext()).thenReturn(true).thenReturn(false);
...
//
// coreService.addListListener(listener);
// coreService.addExceptionSensorData(0, exceptionSensorData.getThrowableIdentityHashCode(),
// exceptionSensorData);
//
// verify(listener, times(1)).contentChanged(dataList);
//
...
// PlainTimerStorage timerStorage = new PlainTimerStorage(null, 0, 0, 0,
// Collections.<ParameterContentData> emptyList(), false);
...
//
// MethodSensorData methodSensorData = coreService.getMethodSensorData(sensorTypeId, methodId,
// prefix);
...
// exceptionSensorData.getThrowableIdentityHashCode(), exceptionSensorData);
//
// MethodSensorData methodSensorData = coreService.getExceptionSensorData(sensorTypeId,
// exceptionSensorData.getThrowableIdentityHashCode());
