...
// when(registeredSensorConfig.getSettings()).thenReturn(Collections.<String, Object>
// singletonMap("charting", Boolean.TRUE));
//
// // First call
// timerHook.beforeBody(methodId, sensorTypeId, object, parameters, registeredSensorConfig);
// verify(timer, times(1)).getCurrentTime();
//
// timerHook.firstAfterBody(methodId, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
// verify(timer, times(2)).getCurrentTime();
//
// timerHook.secondAfterBody(coreService, methodId, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
...
//
// PlainTimerStorage plainTimerStorage = new PlainTimerStorage(null, platformId, sensorTypeId,
// methodId, null, true);
// plainTimerStorage.addData(secondTimerValue - firstTimerValue, 0.0d);
// verify(coreService).addObjectStorage(eq(sensorTypeId), eq(methodId), (String) eq(null),
// argThat(new PlainTimerStorageVerifier(plainTimerStorage)));
//
// // second one
// timerHook.beforeBody(methodId, sensorTypeId, object, parameters, registeredSensorConfig);
...
// assertThat(timerRawVO.getData().get(0).getData()[0], is(equalTo(secondTimerValue -
// firstTimerValue)));
// assertThat(timerRawVO.getData().get(0).getData()[1], is(equalTo(fourthTimerValue -
// thirdTimerValue)));
//
...
// return false;
// } else if (!ObjectUtils.equals(timerRawVO.getParameterContentData(),
// otherTimerRawVO.getParameterContentData())) {
// return false;
...
// registeredSensorConfig);
//
// verify(coreService, never()).addObjectStorage(anyLong(), anyLong(), anyString(), (IObjectStorage)
// isNull());
// }
//
// @Test
...
// verify(propertyAccessor,
// times(1)).getParameterContentData(registeredSensorConfig.getPropertyAccessorList(), object,
// parameters, result);
// }
//
// @Test
...
// verify(coreService).addObjectStorage(eq(sensorTypeId), eq(methodId), anyString(),
// capture.capture());
...
// timerHook = new TimerHook(timer, platformManager, propertyAccessor, settings,
...
//
// AggregateTimerStorage aggregateTimerStorage = new AggregateTimerStorage(null, platformId,
// sensorTypeId, methodId, null, true);
// aggregateTimerStorage.addData(secondTimerValue - firstTimerValue, -1.0d);
// verify(coreService).addObjectStorage(eq(sensorTypeId), eq(methodId), (String) eq(null),
// argThat(new AggregateTimerStorageVerifier(aggregateTimerStorage)));
//
// verifyNoMoreInteractions(timer, platformManager, coreService, registeredSensorConfig);
// verifyZeroInteractions(propertyAccessor, object, result);
// }
...
// verify(registeredSensorConfig).getSettings();
//
// OptimizedTimerStorage optimizedTimerStorage = new OptimizedTimerStorage(null, platformId,
// sensorTypeId, methodId, null, true);
// optimizedTimerStorage.addData(secondTimerValue - firstTimerValue, -1.0d);
// verify(coreService).addObjectStorage(eq(sensorTypeId), eq(methodId), (String) eq(null),
// argThat(new OptimizedTimerStorageVerifier(optimizedTimerStorage)));
//
// verifyNoMoreInteractions(timer, platformManager, coreService, registeredSensorConfig);
// verifyZeroInteractions(propertyAccessor, object, result);
// }
...
// return false;
// } else if (!ObjectUtils.equals(timerData.getParameterContentData(),
// otherTimerData.getParameterContentData())) {
// return false;
...
// PlainTimerStorage plainTimerStorage = new PlainTimerStorage(null, platformId, sensorTypeId,
// methodId, null, true);
// plainTimerStorage.addData(secondTimerValue - firstTimerValue, (secondCpuTimerValue -
// firstCpuTimerValue) / 1000000.0d);
// verify(coreService).addObjectStorage(eq(sensorTypeId), eq(methodId), (String) eq(null),
// argThat(new PlainTimerStorageVerifier(plainTimerStorage)));
//
// verifyNoMoreInteractions(timer, platformManager, coreService, registeredSensorConfig);
...
//
// timerHook.firstAfterBody(methodIdTwo, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
// timerHook.secondAfterBody(coreService, methodIdTwo, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
// PlainTimerStorage plainTimerStorageTwo = new PlainTimerStorage(null, platformId, sensorTypeId,
// methodIdTwo, null, true);
// plainTimerStorageTwo.addData(thirdTimerValue - secondTimerValue, (thirdCpuTimerValue -
// secondCpuTimerValue) / 1000000.0d);
// verify(coreService).addObjectStorage(eq(sensorTypeId), eq(methodIdTwo), (String) eq(null),
// argThat(new PlainTimerStorageVerifier(plainTimerStorageTwo)));
//
// timerHook.firstAfterBody(methodIdOne, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
// timerHook.secondAfterBody(coreService, methodIdOne, sensorTypeId, object, parameters, result,
// registeredSensorConfig);
// PlainTimerStorage plainTimerStorageOne = new PlainTimerStorage(null, platformId, sensorTypeId,
// methodIdOne, null, true);
// plainTimerStorageOne.addData(fourthTimerValue - firstTimerValue, (fourthCpuTimerValue -
// firstCpuTimerValue) / 1000000.0d);
// verify(coreService).addObjectStorage(eq(sensorTypeId), eq(methodIdOne), (String) eq(null),
// argThat(new PlainTimerStorageVerifier(plainTimerStorageOne)));
// }
//
// }
