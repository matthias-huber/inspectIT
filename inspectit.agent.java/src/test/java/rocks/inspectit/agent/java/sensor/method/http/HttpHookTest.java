...
//
// httpHook.firstAfterBody(methodId, sensorTypeId, servlet, parameters, result,
// registeredSensorConfig);
//
// httpHook.secondAfterBody(coreService, methodId, sensorTypeId, servlet, parameters, result,
// registeredSensorConfig);
//
// Mockito.verify(coreService).addMethodSensorData(Matchers.eq(sensorTypeId), Matchers.eq(methodId),
// (String) Matchers.eq(null), Matchers.argThat(new HttpTimerDataVerifier(data)));
//
...
//
// httpHook.firstAfterBody(methodId12, sensorTypeId, servlet, parametersHttp, result,
// registeredSensorConfig);
// httpHook.secondAfterBody(coreService, methodId12, sensorTypeId, servlet, parametersHttp, result,
// registeredSensorConfig);
//
// httpHook.firstAfterBody(methodId11, sensorTypeId, servlet, parametersNoHttp, result,
// registeredSensorConfig);
// httpHook.secondAfterBody(coreService, methodId11, sensorTypeId, servlet, parametersNoHttp,
// result, registeredSensorConfig);
//
// Mockito.verify(coreService).addMethodSensorData(Matchers.eq(sensorTypeId),
// Matchers.eq(methodId12), (String) Matchers.eq(null),
...
//
// httpHook.firstAfterBody(methodId22, sensorTypeId, servlet, parametersNoHttp, result,
// registeredSensorConfig);
// httpHook.secondAfterBody(coreService, methodId22, sensorTypeId, servlet, parametersNoHttp,
// result, registeredSensorConfig);
//
// httpHook.firstAfterBody(methodId21, sensorTypeId, servlet, parametersHttp, result,
// registeredSensorConfig);
// httpHook.secondAfterBody(coreService, methodId21, sensorTypeId, servlet, parametersHttp, result,
// registeredSensorConfig);
//
// Mockito.verify(coreService).addMethodSensorData(Matchers.eq(sensorTypeId),
// Matchers.eq(methodId21), (String) Matchers.eq(null),
...
//
// httpHook.firstAfterBody(methodId4, sensorTypeId, servlet, parameters4, result,
// registeredSensorConfig);
// httpHook.secondAfterBody(coreService, methodId4, sensorTypeId, servlet, parameters4, result,
// registeredSensorConfig);
//
// httpHook.firstAfterBody(methodId3, sensorTypeId, servlet, parameters3, result,
// registeredSensorConfig);
// httpHook.secondAfterBody(coreService, methodId3, sensorTypeId, servlet, parameters3, result,
// registeredSensorConfig);
//
// httpHook.firstAfterBody(methodId2, sensorTypeId, servlet, parameters2, result,
// registeredSensorConfig);
// httpHook.secondAfterBody(coreService, methodId2, sensorTypeId, servlet, parameters2, result,
// registeredSensorConfig);
//
// httpHook.firstAfterBody(methodId1, sensorTypeId, servlet, parameters1, result,
// registeredSensorConfig);
// httpHook.secondAfterBody(coreService, methodId1, sensorTypeId, servlet, parameters1, result,
// registeredSensorConfig);
//
// Mockito.verify(coreService).addMethodSensorData(Matchers.eq(sensorTypeId),
// Matchers.eq(methodId2), (String) Matchers.eq(null),
// Matchers.argThat(new HttpTimerDataVerifier((HttpTimerData) data)));
//
// // No other data must not be pushed!
// Mockito.verifyNoMoreInteractions(coreService);
...
// assertThat(data.getHttpInfo().getRequestMethod(),
// is(equalTo(other.getHttpInfo().getRequestMethod())));
