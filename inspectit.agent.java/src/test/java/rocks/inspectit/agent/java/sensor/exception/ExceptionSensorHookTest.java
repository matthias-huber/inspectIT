...
//
// @Test
// public void throwableObjectWasCreated() throws InstantiationException, IllegalAccessException,
...
//
// exceptionHook.afterConstructor(coreService, constructorId, sensorTypeId, exceptionObject,
// parameters, registeredSensorConfig);
...
//
// @Test
// public void throwableObjectDifferentThenRSCTargetClass() throws InstantiationException,
// IllegalAccessException, IdNotAvailableException {
// long constructorId = 5L;
// long sensorTypeId = 3L;
// long platformId = 1L;
//
...
//
// @Test
// public void throwableObjectCreatedThrownAndHandled() throws InstantiationException,
// IllegalAccessException, IdNotAvailableException {
// long methodId = 5L;
...
// MyTestException exceptionObject = MyTestException.class.newInstance();
//
// ExceptionSensorData exceptionSensorData = new ExceptionSensorData(new
// Timestamp(System.currentTimeMillis()), platformId, sensorTypeId, methodIdTwo);
...
// parameters, registeredSensorConfig);
// verify(platformManager, times(1)).getPlatformId();
// verify(coreService, times(1)).addExceptionSensorData(eq(sensorTypeId),
// eq(exceptionSensorData.getThrowableIdentityHashCode()), argThat(new
// ExceptionSensorDataVerifier(exceptionSensorData)));
//
// exceptionSensorData.setExceptionEvent(ExceptionEvent.PASSED);
// exceptionHook.dispatchOnThrowInBody(coreService, methodId, sensorTypeId, object, exceptionObject,
// parameters, registeredSensorConfig);
...
// exceptionHook.dispatchBeforeCatchBody(coreService, methodIdTwo, sensorTypeId, exceptionObject,
...
//
// @Test
// public void differentThrowableObjectsCreatedAndThrown() throws InstantiationException,
// IllegalAccessException, IdNotAvailableException {
// long methodId = 5L;
// long constructorId = 4L;
// long sensorTypeId = 3L;
...
// when(registeredSensorConfig.getTargetClassFqn()).thenReturn(MyTestException.class.getName());
//
// exceptionHook.afterConstructor(coreService, constructorId, sensorTypeId, firstExceptionObject,
// parameters, registeredSensorConfig);
// verify(platformManager, times(1)).getPlatformId();
// // verify(coreService,
...
//
// exceptionHook.dispatchOnThrowInBody(coreService, methodId, sensorTypeId, object,
// secondExceptionObject, parameters, registeredSensorConfig);
// verify(platformManager, times(2)).getPlatformId();
//
// verifyNoMoreInteractions(platformManager);
// }
//
// @Test
// public void throwableHasCause() throws InstantiationException, IllegalAccessException,
// IdNotAvailableException, SecurityException, NoSuchFieldException {
// long methodId = 5L;
// long constructorId = 4L;
// long sensorTypeId = 3L;
// long platformId = 1L;
...
// // Throwable
// Field causeField =
// exceptionObject.getClass().getSuperclass().getSuperclass().getDeclaredField("cause");
...
//
// @Test
// public void valueTooLong() throws InstantiationException, IllegalAccessException,
// IdNotAvailableException {
// long constructorId = 5L;
// long sensorTypeId = 3L;
// long platformId = 1L;
...
//
// ExceptionSensorData exceptionSensorData = new ExceptionSensorData(new
// Timestamp(System.currentTimeMillis()), platformId, sensorTypeId, constructorId);
// exceptionSensorData.setExceptionEvent(ExceptionEvent.CREATED);
// exceptionSensorData.setThrowableIdentityHashCode(System.identityHashCode(exceptionObject));
//
...
//
// exceptionHook.afterConstructor(coreService, constructorId, exceptionSensorTypeId,
// exceptionObject, parameters, registeredSensorConfig);
// exceptionHook.dispatchOnThrowInBody(coreService, methodId, exceptionSensorTypeId, object,
// exceptionObject, parameters, registeredSensorConfig);
// exceptionHook.dispatchBeforeCatchBody(coreService, methodId, exceptionSensorTypeId,
// exceptionObject, registeredSensorConfig);
//
// verify(coreService, never()).addExceptionSensorData(anyLong(), anyInt(), (ExceptionSensorData)
// isNull());
// }
//
...
// !exceptionSensorData.getCause().equals(otherExceptionSensorData.getCause())) {
// return false;
// }
// if ((null != exceptionSensorData.getErrorMessage()) &&
// !exceptionSensorData.getErrorMessage().equals(otherExceptionSensorData.getErrorMessage())) {
// return false;
// }
// if
// (!exceptionSensorData.getExceptionEvent().equals(otherExceptionSensorData.getExceptionEvent())) {
// return false;
// }
// if ((null != exceptionSensorData.getThrowableType()) &&
// !exceptionSensorData.getThrowableType().equals(otherExceptionSensorData.getThrowableType())) {
// return false;
// }
// if (exceptionSensorData.getThrowableIdentityHashCode() !=
// otherExceptionSensorData.getThrowableIdentityHashCode()) {
// return false;
// }
//
// return true;
